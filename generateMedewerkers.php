...
$beschikbarefuncties = [
    ...
    ["aantal" => 1,  "naam" => "manager Sales",              "status" => ['A']],
    ["aantal" => 1,  "naam" => "manager Marketing",          "status" => ['A']],
    ...
    ["aantal" => 10, "naam" => "medewerker Sales",           "status" => Medewerkers::$alleEmployeeStatussen],
    ["aantal" => 15, "naam" => "medewerker Marketing",       "status" => Medewerkers::$alleEmployeeStatussen],
];
...
$medewerkers->GenereerMedewerkers($beschikbarefuncties, "./datafiles/");
